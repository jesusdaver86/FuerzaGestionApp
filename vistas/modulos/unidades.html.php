      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas">
        ...
        <tbody>
          ...
          <tr>
            <td>1</td>
            <td><img src="vistas/img/unidades/default/anonymous.png" class="img-thumbnail" width="40px"></td>
            <td>0001</td>
...
<div id="modalAgregarUnidades" class="modal fade" role="dialog">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevaMarca">
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoNroPart" placeholder="Ingresar Numero Parte" required>
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevokmRecorrido" placeholder="Ingresar km recorrido" required>
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="nuevocantPasajeros" min="0" placeholder="Stock" required>
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/unidades/default/anonymous.png" class="img-thumbnail" width="100px">
