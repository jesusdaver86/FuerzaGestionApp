...
class ModeloVentas{
	...
	public static function mdlIngresarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_pasajero, id_vendedor, unidades, impuesto, neto, total, metodo_pago) VALUES (:codigo, :id_pasajero, :id_vendedor, :unidades, :impuesto, :neto, :total, :metodo_pago)");
	...
	public static function mdlEditarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  id_pasajero = :id_pasajero, id_vendedor = :id_vendedor, uniades = :unidades, impuesto = :impuesto, neto = :neto, total= :total, metodo_pago = :metodo_pago WHERE codigo = :codigo");
