...
/*
   public static function mdlAgregarTrabajadores($tabla, $datos){
    ...
    $stmt = $pdo->prepare("INSERT INTO $tabla (nombre, correo, cargo, fechaNacimiento, direccion, foto, cartaMedica, certificadoManejo) VALUES (:nombre, :correo, :cargo, :fechaNacimiento, :direccion, :foto, :cartaMedica, :certificadoManejo)");
