    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoOperador" placeholder="Ingresar operador" required>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Guardar operador</button>

        </div>

        <?php

          $crearoperador = new ControladorOperadores();
          $crearoperador -> ctrCrearOperador();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
          ...
          $editaroperador = new ControladorOperadores();
          $editaroperador -> ctrEditarOperador();
...
<?php
  ...
  $borraroperador = new ControladorOperadores();
  $borraroperador -> ctrBorrarOperador();
