            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <?php
                    ...
                    $itemPasajero = "id";
                    $valorPasajero = $venta["id_pasajero"];

                    $pasajero = ControladorPasajeros::ctrMostrarPasajeros($itemPasajero, $valorPasajero);
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" id="seleccionarPasajero" name="seleccionarPasajero" required>

                    <option value="<?php echo $pasajero["id"]; ?>"><?php echo $pasajero["nombre"]; ?></option>
                    ...
                    <?php
                      ...
                      $marcas = ControladorPasajeros::ctrMostrarPasajeros($item, $valor);
                    ...
                    <span class="input-group-addon"><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modalAgregarPasajero" data-dismiss="modal">Agregar pasajero</button></span>
                ...
                foreach ($listaProducto as $key => $value) {
                  ...
                  $cantPasajerosAntiguo = $respuesta["cantPasajeros"] + $value["cantidad"];
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-3">
                          ...
                          <input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="'.$value["cantidad"].'" cantPasajeros="'.$cantPasajerosAntiguo.'" nuevocantPasajeros="'.$value["cantPasajeros"].'" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoNroUnidad" placeholder="Ingresar dirección" required>
