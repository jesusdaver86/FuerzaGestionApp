...
class ModeloPasajeros{
   ...
   /* public static function mdlMostrarPasajeros($tabla, $item, $valor){
    ...
    public static function mdlMostrarTrabajadores($tabla, $item, $valor) {
    ...
    /*public static function mdlActualizarPasajero($tabla, $item1, $valor1, $valor){*/
...
/*=============================================
    ...
    if($fechaInicial == null){
        ...
        $stmt = Conexion::conectar()->prepare("SELECT YEAR(fecha_c) as year, MONTH(fecha_c) as month, COUNT(*) as total FROM $tabla WHERE fecha_c like '%$fechaFinal%' GROUP BY YEAR(fecha_c), MONTH(fecha_c) ");
        ...
        if($fechaFinalMasUno == $fechaActualMasUno){
            ...
            $stmt = Conexion::conectar()->prepare("SELECT YEAR(fecha) as year, MONTH(fecha) as month, COUNT(*) as total FROM $tabla WHERE fecha_c BETWEEN '$fechaInicial' AND '$fechaFinal' GROUP BY YEAR(fecha_c), MONTH(fecha_c) ORDER BY fecha_c ASC");
