 ...
 <div class="form-group">
  ...
  <div class="input-group">
    ...
    <!-- ENTRADA PARA CANT. PASAJEROS -->
            ...
            <input type="hidden" class="form-control input-lg nuevoPorcentaje" min="0" value="40" required>
             <!-- ENTRADA PARA SUBIR FOTO DE LA UNIDAD -->
            ...
            <div class="form-group">
              ...
              <label for="editarImagen">Imagen de la Unidad:</label>


              <input type="file" class="nuevaFoto" id="editarImagen" name="editarImagen">
              ...
              <img src="vistas/img/unidades/default/anonymous.png" class="img-thumbnail previsualizarEditar" width="100px">
...
/*$eliminarUnidad = ControladorUnidades::ctrEliminarUnidad();*/
