    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (respuesta.length > 0) {
                $("#idPasajero").val(respuesta[0]["id"]);
                $("#editarPasajero").val(respuesta[0]["nombre"]);
                $("#editarDocumentoId").val(respuesta[0]["documento"]);
                $("#editarGerencia").val(respuesta[0]["gerencia"]);
                $("#editarNroUnidad").val(respuesta[0]["nroUnidad"]);
                $("#editarFechaC").val(respuesta[0]["fecha_c"]);
            } else {
                console.error("No se encontraron datos para el pasajero.");
            }
        },
