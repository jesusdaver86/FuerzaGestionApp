...
<script type="text/javascript">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control input-lg" name="nuevaFechaC" placeholder="Ingresar fecha" required>
...
<select class="form-control input-lg" name="nuevoNroUnidad" id="nuevoNroUnidad" required>
  <option value="">Seleccione una ruta</option>
  <option value="CABIMAS CVP 01-- LAGUNILLAS">CABIMAS CVP 01-- LAGUNILLAS</option>
  <option value="CABIMAS CVP 02-- LAGUNILLAS">CABIMAS CVP 02-- LAGUNILLAS</option>
  <option value="TTCC LA SALINA -- LAGUNILLAS">TTCC LA SALINA -- LAGUNILLAS</option>
  ...
  <option value="AMARILLO 2 MENE GRANDE- BARROSO - PUEBLO NUEVO - SAN LORENZO">AMARILLO 2 MENE GRANDE- BARROSO - PUEBLO NUEVO - SAN LORENZO</option>
            ...
            <!--div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" id="rutas" name="rutas" class="form-control input-lg" disabled>
            ...
            <!--div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarFechaC" id="editarFechaC"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required>
